...
const DEFAULT_PRESETS: WorkflowPreset[] = [
  ...
  },
  {
    ...
    params: {
      ...
      prompt:
        "beautiful landscape, golden hour, wide angle, nature photography",
  ...
  },
  {
    ...
    params: {
      ...
      prompt:
        "anime character, masterpiece, best quality, detailed anime style",
      negative_prompt:
        "realistic, photo, 3d, low quality, worst quality, bad anatomy",
    },
    createdAt: Date.now(),
    updatedAt: Date.now(),
  },
  {
    ...
    params: {
      ...
      prompt:
        "photorealistic, highly detailed, professional photography, 8k, dslr",
  ...
  },
  {
    ...
    params: {
      ...
      sampler_name: "Euler a",
      prompt:
        "digital art, illustration, artistic, painterly style, trending on artstation",
