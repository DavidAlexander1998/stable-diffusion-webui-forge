...
export const DEFAULT_TEMPLATES: PromptTemplate[] = [
  {
    ...
    template:
      "portrait photo of {subject}, {style}, {lighting}, professional photography",
  ...
  },
  {
    ...
    category: "Photography",
    template:
      "{location}, {time_of_day}, {weather}, landscape photography, wide angle",
  ...
  },
  {
    ...
    template:
      "{character_description}, character design, {art_style}, full body, white background",
  ...
  },
  {
    ...
    category: "Illustration",
    template:
      "{environment}, {mood}, {lighting}, concept art, detailed background",
